...
function add_event_listener_to_bottom_rod()
{
    window.addEventListener("keydown", function (event)
    {
        ...
        if (code == 39)
        {
            ...
            left_numeric += 20;
            if (left_numeric + second_rod.offsetWidth > document.documentElement.clientWidth)
            {
                left_numeric = document.documentElement.clientWidth - second_rod.offsetWidth;
            }
...
function add_event_listener_to_top_rod()
{
    window.addEventListener("keydown", function (event)
    {
        let code = event.keyCode;
...
function set_interval_for_ball()
{
    ...
    {
        score.innerText= current_score.first +" : " + current_score.second;
...
centeralise_element(ball);
show_score();
add_event_listener_to_top_rod();
add_event_listener_to_bottom_rod();
